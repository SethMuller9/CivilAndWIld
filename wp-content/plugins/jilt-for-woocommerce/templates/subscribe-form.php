	...
	<form method="post" class="wc_jilt_subscribe_form" action="#wc_jilt_subscribe_form" <?php do_action( 'wc_jilt_subscribe_form_tag' ); ?>>
		...
		<?php if ( $show_names ) : ?>
			...
			<p class="woocommerce-FormRow woocommerce-FormRow--first form-row form-row-first">
				<label for="wc_jilt_fname"><?php esc_html_e( 'First name', 'jilt-for-woocommerce' ); ?><?php echo $require_names ? ' <span class="required">*</span>' : ''; ?></label>
				<input type="text" class="woocommerce-Input woocommerce-Input--text input-text" name="wc_jilt_fname" value="<?php if ( $contact_data['first_name'] ) echo esc_attr( $contact_data['first_name'] ); ?>" <?php echo $require_names ? ' required' : ''; ?>/>
			</p>

			<p class="woocommerce-FormRow woocommerce-FormRow--last form-row form-row-last">
				<label for="wc_jilt_lname"><?php esc_html_e( 'Last name', 'jilt-for-woocommerce' ); ?><?php echo $require_names ? ' <span class="required">*</span>' : ''; ?></label>
				<input type="text" class="woocommerce-Input woocommerce-Input--text input-text" name="wc_jilt_lname" value="<?php if ( $contact_data['last_name'] ) echo esc_attr( $contact_data['last_name'] ); ?>" <?php echo $require_names ? ' required' : ''; ?>/>
			</p>

		<?php endif; ?>

		<p class="woocommerce-form-row woocommerce-form-row--wide form-row form-row-wide">
			<label for="wc_jilt_email"><?php esc_html_e( 'Email address', 'jilt-for-woocommerce' ); ?>&nbsp;<span class="required">*</span></label>
			<input type="email" class="woocommerce-Input woocommerce-Input--text input-text" name="wc_jilt_email" autocomplete="email" value="<?php if ( $contact_data['email'] ) echo esc_attr( $contact_data['email'] ); ?>" />
		</p>
		...
		<p class="woocommerce-FormRow form-row">
			<?php wp_nonce_field( 'wc-jilt-subscribe' ); ?>
